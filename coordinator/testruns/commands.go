...
var roleBinaries = map[common.SystemRole]string{
	...
	common.SystemRoleTxPlayer:              "sources/build/tools/txtester/tx-player",
...
var roleParameters = map[common.SystemRole][]string{
	...
	common.SystemRoleAtomizer: []string{
		"%CFG%",
		"%IDX%",
		"%SAMPLE_COUNT%",
	},
	common.SystemRoleAtomizerCli: []string{
		"%CFG%",
		"%IDX%",
		"%SIGN_TXS%",
	},
	...
	common.SystemRoleTxPlayer:         []string{},
